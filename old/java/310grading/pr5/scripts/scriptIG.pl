...
$ProjGradingDir = $Scripts;
$ProjGradingDir =~ s/scripts//;

$TestCaseDir       = "$ProjGradingDir/tests";
$GradersBuildCommand = "$TestCaseDir/gradersBuilder";


$publicTestCaseBaseURL = 
    "http://www.cs.albany.edu/~sdc/CSI310/Spr12/Proj/Proj5/";
