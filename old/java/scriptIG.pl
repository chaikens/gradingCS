...
###################### Directory Info ########################
chomp( $cwd = `pwd`);
$ClassAcctHomeDir = $cwd . "/201grading";
$ProjGradingDir = "$ClassAcctHomeDir/private/pr2";

$TestCaseDir       = "$ClassAcctHomeDir/pr2/GradingCases";
...
@PartsIGList = ("whole-vignette", "rect-vignette");
@PartsIGexeName = ("$TestCaseDir/whole-vignette/WholeUnitTest.sh", 
...
$TestCompileDir = "/tmp/201TA$TAUserName";
