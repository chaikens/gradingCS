...
Some kind of version history must be included.
Some .class files must be present, as evidence of testing.\n";
...
$FileToDiffFrom = "/dev/null";
                  #cwd()."/GradingCases/Picture.java.nomain";
$SubmittedFileToDiffTo = "Album.java";
...
$VersionHistoryPoints = 5;
$EvidenceOfTestingPoints = 5;
$MainsTestMethodsPoints = 0;
...
# On time Project Deadline  12/8/12 23:59 (11:59PM)
$DUEhour = 23;
$DUEmin  = 59;
$DUEmon  = 11;         # Month January = 0
$DUEmday = 8;
...
$publicTestCaseBaseURL = 
    "http://www.cs.albany.edu/~sdc/CSI201/Fal12/Proj/Proj5/";
...
sub NonFunReqCheck( )  #---------------------------------------------------
{
    ...
    if( $EvidenceOfTestingPoints )
    {
	print "Evidence such as .class files that you TESTED as you worked:";
	$value = getNumber(0.0, 1.0);
	scoreThisQualityOutof 
	    "Evidence such as .class files that you TESTED as you worked:",
	    $value,
	    $EvidenceOfTestingPoints;
    }
