...
public class T05FourPictsJagged extends TesterBase
{
    private static final String  fmt = "%24s: %s%n";

    public T05FourPictsJagged()
    {
	super();
    }
	...
	try{
	    ...
	    addPictureP_M.invoke(alb,Three100);	
	    addPictureP_M.invoke(alb,Four160);	
	...
	T05FourPictsJagged me = new T05FourPictsJagged();
