...
public class T04ThreePictsGrowing extends TesterBase
{
    private static final String  fmt = "%24s: %s%n";

    public T04ThreePictsGrowing()
    {
	super();
    }
	...
	try{
	    ...
	    addPictureP_M.invoke(alb,Three200);
	...
	T04ThreePictsGrowing me = new T04ThreePictsGrowing();
